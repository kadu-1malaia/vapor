...
(6, 'Eduardo Rasera Guassi', '47785345813', 'dudu@uol.com', '123');
...
CREATE TABLE `mensagem` (
  ...
  `assunto_da_menasgem` varchar(10) NOT NULL,
  `mensagem_usuario` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `mensagem` (`id`, `nome_usuario`, `email_usuario`, `assunto_da_menasgem`, `mensagem_usuario`) VALUES
(11, 'eduardo', 'edu@dudu.com', 'duvida  ', 'Se esaa mensagem for realmente enviada como vai fazer para ela funcionar direito?');

-- --------------------------------------------------------

--
-- Estrutura da tabela `mensagem_arquivada`
--

CREATE TABLE `mensagem_arquivada` (
  `id` int(4) NOT NULL,
  `nome_usuario` varchar(50) NOT NULL,
  `email_usuario` varchar(50) NOT NULL,
  `assunto_da_mensagem` varchar(50) NOT NULL,
  `mensagem_usuario` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Extraindo dados da tabela `mensagem_arquivada`
--

INSERT INTO `mensagem_arquivada` (`id`, `nome_usuario`, `email_usuario`, `assunto_da_mensagem`, `mensagem_usuario`) VALUES
(9, 'du', 'dudu@dudu.com', 'elogio  ', 'Nossa que Divertido'),
(7, 'e', 'DUDU@UOL.COM', 'suporte ', 'asd'),
(8, 'du', 'dudu@dudu.com', 'elogio  ', 'Nossa que Divertido'),
(0, 'dudu', 'd@duud.com', 'elogio  ', 'Nossa que mensagem legal');
